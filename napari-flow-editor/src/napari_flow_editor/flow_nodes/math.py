...
def interactive_crop(image_input, t_crop=":"):
    ...
    # Setup function to create the layer and return an event
    def setup_crop_layer():
    ...
    # Cleanup function to get data and delete the layer
    def cleanup_crop_layer():
        viewer = napari.current_viewer()
    ...
    shapes_data = interactive_worker.wait_for_user_event(setup_crop_layer, cleanup_crop_layer)
    if not shapes_data:
        raise ValueError("No ROI data received.")
